...
/**
 * This file keeps track of upgrades to the directlink module
 *
...
/**
 * Execute directlink upgrade from the given old version
 *
...
function xmldb_directlink_upgrade($oldversion) {
    ...
    // for demonstrative purposes and to show how the directlink
    // iself has been upgraded.

    // For each upgrade block, the file directlink/version.php
...
//
//        // Define field timecreated to be added to directlink
//        $table = new xmldb_table('directlink');
...
//        }
//
//        // Define field timemodified to be added to directlink
//        $table = new xmldb_table('directlink');
...
//        }
//
//        // Define index course (not unique) to be added to directlink
//        $table = new xmldb_table('directlink');
...
//        upgrade_mod_savepoint(true, 2007040101, 'directlink');
//    }
//
...
//
//        upgrade_mod_savepoint(true, 2007040200, 'directlink');
//    }
